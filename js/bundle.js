...
function openModal(modalSelector, modalTimerId) {
  ...
  if (modalTimerId) {
    //необходимо для того, чтобы окно не открылось модальное окно, 
    //если пользователь откроет его раньше чем закончит работу таймер
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2022-06-01');
